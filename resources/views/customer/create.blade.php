                        ...
                        <form action="{{ route('customer.store') }}" method="POST">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group input-group-merge">
                                            <input disable type="text" name="kode_user" class="form-control"
                                                value="{{ $kode }}">
                                        </div>
                                        @error('id_customer')
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="email" name="email" id="basic-icon-default-company"
                                                class="form-control" placeholder="email@laundry.com">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text" name="no_telp" id="basic-icon-default-phone"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <textarea name="alamat" rows="4" class="form-control" placeholder="Jln. Jendral Sudirman No 45"></textarea>
                                </div>
                                @error('alamat')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
